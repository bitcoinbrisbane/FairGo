      ...
      <div className="hero-grid">
        <div>
          ...
          <p className="hero-sub">
            Deposit <b>AUDM</b>. Cop a fine? The <b>FAIRGO Treasury</b> reimburses you on-chain —
            verified by holders, paid in seconds. Council can keep the meter running. We've got
            your back.
          </p>
